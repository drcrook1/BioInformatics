    ...
    public class AnyReading : IAllBandSensorReadings
    {
        ...
        public string ToCaloriesStatus()
        {
            return string.Format("{0} status : Calories={1} @ {2}",
                SensorType.ToString("G"), CaloriesToday.ToString(), Timestamp.ToString(timestampformat));
        }

        public AnyReading(IBandCaloriesReading input)
        {
            SensorType = BandSensorType.Calories;
            CaloriesToday = input.Calories;
            Timestamp = input.Timestamp;
        ...
        public AnyReading(Microsoft.Band.Sensors.IBandSensorReading input)
        {
            Timestamp = input.Timestamp;
        }
        ...
        [DataMember]
        public long CaloriesToday { get; set; }

        [DataMember]
        public Microsoft.Band.Sensors.MotionType CurrentMotion { get; set; }
        ...
        [DataMember]
        public Microsoft.Band.Sensors.UVIndexLevel IndexLevel { get; set; }
        ...
        [DataMember]
        public Microsoft.Band.Sensors.HeartRateQuality Quality { get; set; }
