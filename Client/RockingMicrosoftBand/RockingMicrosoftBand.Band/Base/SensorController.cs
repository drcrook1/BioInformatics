...
using RockingMicrosoftBand.Band.Constants;
...
namespace RockingMicrosoftBand.Band.Base
{
    public class SensorController<T> : ViewModelBase where T : IBandSensorReading
    {
        ...
        public async Task<bool> GetConsent()
        {
            ...
            //{
                return HasConsent = HasConsent || Sensor.GetCurrentUserConsent() == UserConsent.Granted || await Sensor.RequestUserConsentAsync();
            //});
